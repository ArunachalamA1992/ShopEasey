...
const PrivacyPolicy = () => {
                ...
                <View style={{ width: '100%', alignItems: 'center' }}>
                    ...
                    <View style={{ width: '95%', padding: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            ...
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We furnish the general privacy terms for you to have an in-depth glance.</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We collect personal information like your contact, billing, credit, and profile details.</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                Icontag={'AntDesign'}
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We utilize privacy information for business objectives like completing transactions, billing products, responding to service requests, and protecting our assets.</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                Icontag={'AntDesign'}
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We do not furnish your personal information to any third parties until they get recognized under our terms & conditions. We use a variety of physical or digital protocols to</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                Icontag={'AntDesign'}
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>protect your personal information.</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                Icontag={'AntDesign'}
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We implement reasonable methods to delete your personal information when we no longer need it.</Text>
                        </View>
                    </View>

                    <View style={{ width: '95%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: Manrope.SemiBold, fontWeight: '800', letterSpacing: 0.5, textAlign: 'justify', lineHeight: 20 }}>Access and choice</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We use website cookies and other secured technologies to restrict children below 13 years.</Text>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We implement best practices for location-based services</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                Icontag={'AntDesign'}
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We might provide access to location-based information to enable third parties to deliver you the required service.</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                Icontag={'AntDesign'}
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>You can modify your contact information on our website by accessing the profile.</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                Icontag={'AntDesign'}
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>You can delete the information that is not mandatory to us by logging into your profile on our website.</Text>
                        </View>
                    </View>

                    <View style={{ width: '95%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: Manrope.SemiBold, fontWeight: '800', letterSpacing: 0.5, textAlign: 'justify', lineHeight: 20 }}>Frequent updates</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
                            <Iconviewcomponent
                                ...
                                iconstyle={{ marginTop: 0 }}
                            />
                            <Text style={{ width: '100%', paddingHorizontal: 10, fontSize: 13, color: Color.cloudyGrey, fontFamily: Manrope.Regular, textAlign: 'justify', letterSpacing: 0.5, lineHeight: 22 }}>We keep changing these privacy policies from period to period and you should always stay tuned with us to know the latest changes.</Text>
                        </View>
                    </View>
    ...
    function renderFooterItem(item, index) {
        try {
            return (
                <View style={{ width: '95%', padding: 10, height: height, alignItems: 'center', backgroundColor: 'white' }}>

                    <View style={{ width: '100%', alignItems: 'center' }}>
                        <Text style={{ width: '95%', fontSize: 16, letterSpacing: 0.5, color: 'black', fontWeight: '800', fontFamily: Manrope.SemiBold }}>Contact Us</Text>
                    ...
                    <View style={{ width: '100%', backgroundColor: Color.softGrey, paddingVertical: 2, marginVertical: 20 }}></View>
                    <View style={{ width: '100%', alignItems: 'center', paddingHorizontal: 10, marginVertical: 0 }}>
