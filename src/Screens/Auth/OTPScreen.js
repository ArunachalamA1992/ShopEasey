            ...
            <DismissKeyboard>
                <View
                                            ...
                                            <View style={{ width: '95%', alignItems: 'flex-start' }}>
                                                <Text
                                                    style={{
                                                        ...
                                                        fontSize: 13,
                                                        color: '#666',
                                                        fontFamily: Manrope.Regular, lineHeight: 20
                                                    }}>
                    ...
                    <Text style={{ fontSize: 14, color: 'white' }}>Decline</Text>
                                    ...
                                    <TouchableOpacity onPress={() => VerifyOTP(navigation)} style={{ width: '100%', height: 40, justifyContent: 'center', alignItems: 'center', backgroundColor: Color.primary, borderRadius: 40, }}>
                    ...
                    <View
                        ...
                        <Text
                            style={{
                                ...
                                textAlign: 'center',
                                color: Color.black,
                                marginVertical: 10, letterSpacing: 0.5
                            }}>
                            Enter OTP
                        </Text>
                        <Text style={{ fontSize: 14, color: Color.cloudyGrey, fontFamily: Manrope.Regular, letterSpacing: 0.5, paddingTop: 10 }}>Enter the verification code we sent to your</Text>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={{ fontSize: 14, color: Color.cloudyGrey, fontFamily: Manrope.Regular, letterSpacing: 0.5 }}>number </Text>
                            <Text style={{ fontSize: 16, color: Color.lightBlack, fontFamily: Manrope.Medium, letterSpacing: 0.5 }}>+91 {number?.substring(0, 5).concat("*****")}</Text>
                        </View>
                        ...
                        <TouchableOpacity onPress={() => VerifyOTP(navigation)} style={{ width: '80%', height: 50, justifyContent: 'center', alignItems: 'center', backgroundColor: Color.primary, borderRadius: 5 }}>
                            <Text style={{ fontSize: 16, color: Color.white, fontFamily: Manrope.SemiBold, letterSpacing: 0.5 }}>Verify</Text>
                        </TouchableOpacity>
                        {/* <Button
                            title={'Submit'}
                            titleStyle={{}}
