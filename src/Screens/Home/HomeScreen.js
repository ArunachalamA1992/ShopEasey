                            ...
                            return (
                                <View style={{ width: '100%', alignItems: 'center' }}>
                                    ...
                                    <View
                                        ...
                                        <View style={{ width: '100%', flexDirection: 'row', marginVertical: 10, alignItems: 'center' }}>
                                            <SwiperFlatList
                                                autoplay
                                                autoplayDelay={1}
                                                autoplayLoop
                                                ...
                                                paginationStyleItem={{ width: 25, height: 5, marginTop: 30 }}
                                                renderItem={({ item }) => (
                                    ...
                                    <View style={{
                                        ...
                                        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                                            {trendData.map((item, index) => {
                                                return (
                                                    <View style={{ width: 120, height: 150, justifyContent: 'center', alignItems: 'center', borderTopStartRadius: 5, borderTopRightRadius: 5, margin: 5 }}>
                                                        <View style={{ width: 120, height: 150, borderTopStartRadius: 5, borderTopRightRadius: 5, }}>
                                                            <Image
                                                                source={item.ban_image}
                                                                style={{ width: '100%', height: '100%', resizeMode: 'contain', borderTopStartRadius: 5, borderTopRightRadius: 5, }}
                                                            />
                                                        </View>
                                                        <View style={{ width: 120, height: 35, justifyContent: 'center', alignItems: 'center', backgroundColor: Color.primary, position: 'absolute', bottom: 0, borderBottomStartRadius: 5, borderBottomRightRadius: 5 }}>
